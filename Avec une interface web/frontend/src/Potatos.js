...
function Potatos() {
    ...
    const chargerDonnees = async () => {
        try {
            const reponse = await fetch('http://127.0.0.1:8000/potato/donneInitiale');
            if (reponse.ok) {
    ...
    const handlelancelagenreation = async () => {
        try {
            const response = await fetch('http://127.0.0.1:8000/potato/genere', {
                method: 'POST',
                headers: {
    ...
    const fetchGraphiqueData = async () => {
       
        try {
            const response = await fetch('http://127.0.0.1:8000/potato/Graphique', {
                method: 'POST',
                headers: {
            ...
            // Ici, vous pouvez traiter la réponse. Par exemple, si vous attendez du JSON :
            const data = await response.json();
            console.log(data);
            // Traitez 'data' comme nécessaire
        } catch (error) {
    ...
    <div>
       <div className="flex items-center my-8 pl-8">
               <p className="text-4xl font-medium mt-5 leading-none text-teal-500 mr-2">Augmentation de données pour le fichier de pommes de terre</p>
            </div> 
      ...
      <div className="flex w-full  m-4 flex-col">
            ...
            {QualiteDesDonneesGenere &&  (
                 ...
                 <div className="inline-block min-w-full py-2 px-4 sm:px-6 lg:px-8">
                    ...
                    <div>
                        <img src={`${process.env.PUBLIC_URL}/Image_genere/potatohisto_month_${paramtre}.png`} alt="Potato boxplot" />
                    </div>
                 </div>
                 <div className="inline-block min-w-full py-2 px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center my-4 pl-4">
                    ...
                    <div> 
                        <img src={`${process.env.PUBLIC_URL}/Image_genere/potatocumulative_${paramtre}.png`} alt="Potato boxplot" />
                    </div>
                 </div>
                 <div className="inline-block min-w-full py-2 px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center my-4 pl-4">
                    ...
                    <div> 
                        <img src={`${process.env.PUBLIC_URL}/Image_genere/potatoboxplot_${paramtre}.png`} alt="Potato boxplot" />
                    </div>
                 </div>
             </div>
            )}

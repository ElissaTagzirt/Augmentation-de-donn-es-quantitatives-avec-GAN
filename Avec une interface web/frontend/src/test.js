...
function Potatos() {
    ...
    const chargerGraphe = async (event) => {
        event.preventDefault(); // Empêche le comportement par défaut de l'événement (souvent, recharger la page)
    
        const url = 'http://127.0.0.1:8000/potato/Graphique'; // URL de l'API
        const headers = {

...
def representer_selon_mois_histogramme(param, culture, df_base, df_generated):
    ...
    plt.savefig('../frontend/public/Image_genere/'+culture+'histo_month_'+param+'.png')

def representer_selon_mois_boxplot(param, culture, df_base, df_generated):
    ...
    # Enregistrer le graphique au format PNG
    plt.savefig('../frontend/public/Image_genere/'+culture+'boxplot_'+ param +'.png')
...
def plot_cumulative_frequency(param, culture, df_base, df_generated):
    ...
    # Enregistrer le graphique au format PNG
    plt.savefig('../frontend/public/Image_genere/'+culture+'cumulative_'+ param +'.png')
    #plt.show()

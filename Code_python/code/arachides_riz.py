...
train_nb = 100
arachides_riz_train('./data/arachides_riz.xlsx', 100, train_nb, 32, 100, 'arachides_riz')

# Géneration des données
arachides_riz_generator('./data/arachides_riz_generated.csv', 40, 'arachides_riz')
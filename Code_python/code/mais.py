...
train_nb = 1000
mais_train('./data/maïs.xlsx', 100, train_nb, 32, 100, 'mais')

# Géneration des données
mais_generator('./data/maïs_generated.csv', 40, 'mais')
    
# Qualité des données
df_base, df_generated = charger_Fichier("xlsx", './data/maïs.xlsx', './data/maïs_generated.csv')

# Histogramme
representer_selon_mois_histogramme('Wind', 'mais', df_base, df_generated)

# Boxplot
representer_boxplot('Wind', 'mais', df_base, df_generated)

# Fréquences cumulées
plot_cumulative_frequency('Wind', 'mais', df_base, df_generated)

...
train_nb = 100
riz_train('./data/riz.csv', 100, train_nb, 32, 100, 'riz')

# Géneration des données
riz_generator('./data/riz_generated.csv', 40, 'riz')
    
# Qualité des données
df_base, df_generated = charger_Fichier("csv", './data/riz.csv', './data/riz_generated.csv')

# Histogramme
representer_selon_mois_histogramme('water req', 'riz', df_base, df_generated)

# Boxplot
representer_boxplot('water req', 'riz', df_base, df_generated)

# Fréquences cumulées
plot_cumulative_frequency('water req', 'riz', df_base, df_generated)
...
train_nb = 100
tomato_train('./data/tomates.csv', 100, train_nb, 32, 100, 'tomato')

# Géneration des données
tomato_generator('./data/tomates_generated.csv', 40, 'tomato')
    
# Qualité des données
df_base, df_generated = charger_Fichier("csv", './data/tomates.csv', './data/tomates_generated.csv')

# Boxplot
representer_boxplot('hour', 'tomato', df_base, df_generated)

# Fréquences cumulées
plot_cumulative_frequency('hour', 'tomato', df_base, df_generated)
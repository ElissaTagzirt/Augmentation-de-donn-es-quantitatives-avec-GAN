...
def clean_df(df):
    ...
    df_comparative.to_csv('data/website_initiale_comparative.csv', index=False)
...
def generate_data_from_gan(chemin_sortie, num_samples, culture):
    ...
    modified_df.to_csv(chemin_sortie, index=False)

# Entrainement des données
train_nb = 100
train_gan('./data/website.xlsx', 100, train_nb, 32, 100, 'website')

# Géneration des données
generate_data_from_gan('./data/website_generated.csv', 40, 'website')